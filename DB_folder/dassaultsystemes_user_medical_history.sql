...
CREATE TABLE `user_medical_history` (
  ...
  `userMedicineStartDate` datetime NOT NULL,
  `userMedicineEndDate` datetime NOT NULL,
  `userDosageAmount` int NOT NULL,
  `userDosageFrequence` enum('Once','twice','thrice') DEFAULT NULL,
  `userDosageBreakfastTime` time DEFAULT NULL,
  `userDosageLunchTime` time DEFAULT NULL,
  `userDosageDinner` time DEFAULT NULL,
